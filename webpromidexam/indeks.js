...
const programs = {
  theology:['Ilmu Filsafat'],
  nursing:['Keperawatan','Profesi Ners'],
  agriculture:['Pertanian'],
  computer_science:['Sistem Informasi','Teknik Informatika'],
  economic:['Akuntasi','Manajemen'],
  secretary:['Sekretaris'],
  education:['Pendidikan Agama','Pendidikan Bahasa Inggris','Pendidikkan Ekonomi','Pendidika Luar Sekolah']
}
